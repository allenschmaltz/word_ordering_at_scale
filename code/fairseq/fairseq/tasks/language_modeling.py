...
class LanguageModelingTask(FairseqTask):
    ...
    #def load_dataset_ordering(self, split, combine=False, **kwargs):
    def load_dataset_ordering(self, input_ordered_file, input_shuffled_file):
        ...
        assert self.args.raw_text and IndexedRawTextDataset.exists(input_shuffled_file)
        ...
        print('| {} {} examples'.format(input_shuffled_file, len(loaded_datasets[-1])))
